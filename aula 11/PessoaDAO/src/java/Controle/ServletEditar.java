    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                out.print("Erro ao buscar pessoa");
            }
            
            
            
            out.println("<form action=inserir>");
            out.println("<input type='hidden' name='codigo' value="+codigo+">");
            out.println("<input type='text' name='nome' value="+p.getNome()+" >");
            out.println("<input type='number' name='idade' value="+p.getIdade()+" >");
