...
{
    nomeTitulo = document.getElementById("busca").value;
    criaAjax("http://localhost:8080/FiltroLivraria/Filtrador", paramentro + "=" + nomeTitulo, mostrar);
}
function mostrar()
{
...
function testRadiobuton() {
    ...
    if (value !== "all") {
        criaAjax("http://localhost:8080/FiltroLivraria/Filtrador", "categoria=" + value, mostrar);
    }else{
       ajax("http://localhost:8080/FiltroLivraria/Livraria", mostrar); 
    }
}
